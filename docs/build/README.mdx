...
The Build section is split into four parts:

1. [Smart contracts](./smart-contracts/README.mdx)
2. [Applications](./apps/README.mdx)
3. [Tutorials](./tutorials.mdx)
4. [How-to guides](./guides/README.mdx)
...
Tutorials are guided, end-to-end projects for building smart contracts, applications, dapps, and data ingestion pipelines on Stellar.
