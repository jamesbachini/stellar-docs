...
const build: NavbarItem = {
  ...
  position: "left",
  to: "/docs/build",
  className: "mobile-main-menu-item",
  items: [
    {
      to: "/docs/build",
      label: "Overview",
    ...
    },
    {
      ...
      label: "Tutorials",
      activeBasePath: "docs/build/tutorials",
    },
    {
...
const stellar: NavbarItem = {
  href: "https://stellar.org",
  label: "Stellar",
  position: "left",
};

const docs: NavbarItem = {
  to: "/",
  label: "Docs",
  position: "left",
};
...
const funding: NavbarItem = {
  href: "https://stellar.org/grants-and-funding",
  label: "Funding",
  position: "left",
};

const community: NavbarItem = {
